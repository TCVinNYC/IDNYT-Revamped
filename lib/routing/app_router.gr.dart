...
import 'package:idnyt_revamped/modules/home/views/create_course_page.dart'
    as _i9;
import 'package:idnyt_revamped/modules/home/views/enter_id_page.dart' as _i15;
...
import 'package:idnyt_revamped/modules/home/views/student_home_page.dart'
    as _i4;
import 'package:idnyt_revamped/modules/login/views/error_page.dart' as _i12;
import 'package:idnyt_revamped/modules/login/views/login_page.dart' as _i13;
  ...
  final Map<String, _i16.PageFactory> pagesMap = {
    ...
    StudentHomePage.name: (routeData) {
      final args = routeData.argsAs<StudentHomePageArgs>(
          orElse: () => const StudentHomePageArgs());
      return _i16.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i4.StudentHomePage(key: args.key),
      );
    },
    ...
    StudentCourseDetailPage.name: (routeData) {
      ...
      return _i16.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i14.StudentCourseDetailPage(
          key: args.key,
...
/// generated route for
/// [_i4.StudentHomePage]
class StudentHomePage extends _i16.PageRouteInfo<StudentHomePageArgs> {
  StudentHomePage({
    _i17.Key? key,
    List<_i16.PageRouteInfo>? children,
  }) : super(
          StudentHomePage.name,
          args: StudentHomePageArgs(key: key),
          initialChildren: children,
        );

  static const String name = 'StudentHomePage';

  static const _i16.PageInfo<StudentHomePageArgs> page =
      _i16.PageInfo<StudentHomePageArgs>(name);
}

class StudentHomePageArgs {
  const StudentHomePageArgs({this.key});

  final _i17.Key? key;

  @override
  String toString() {
    return 'StudentHomePageArgs{key: $key}';
  }
}
